...
function main(){
    ...
    for (student in temp_students){
        print("swapping for "+{str(student)}+" now, students who requested this dude's mods are: ");
        ...
        for (mod in choices.keys()){
            ...
            for (s in current[mod.course_num]){
                ...
                if (students.includes(s)==false){
                    ...
                    print("Oops "+s.student_id+" has already traded. remove the dude");
                    ...
                    if (student.cur_mod in their_choices){
                        ...
                        print(s.student_id+" could trade!");
